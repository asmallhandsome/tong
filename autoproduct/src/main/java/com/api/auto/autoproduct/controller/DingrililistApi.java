...
* @description:用于获取浙大钉个人日历项目列表
* */
public class DingrililistApi{

    public static JSONObject dingrililist(String appid, String xgh, Date start, Date end){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrililist/query",map,"utf-8");

...
* @description:用于个人详细信息
* */
public class DinguserinfoApi{

    public static JSONObject dinguserinfo(String appid, String xgh){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dinguserinfo/query",map,"utf-8");

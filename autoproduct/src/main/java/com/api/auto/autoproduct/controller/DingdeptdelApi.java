...
* @description:用于删除钉钉部门
* */
public class DingdeptdelApi{

    public static JSONObject dingdeptdel(String appid, String deptid){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingdeptdel/service",map,"utf-8");

...
* @description:用于创建团队日历
* */
public class DingcaladdApi{

    public static JSONObject dingcaladd(String appid, String xgh, String title, String description, String allows){
        try {
            ...
            if (StringUtils.hasText(allows)) {
                parameter.put("allows",allows);
            }
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingcaladd/service",map,"utf-8");

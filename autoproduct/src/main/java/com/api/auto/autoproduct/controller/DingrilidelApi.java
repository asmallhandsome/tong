...
* @description:用于删除浙大钉个人日历项目
* */
public class DingrilidelApi{

    public static JSONObject dingrilidel(String appid, String id, String xgh){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrilidel/service",map,"utf-8");

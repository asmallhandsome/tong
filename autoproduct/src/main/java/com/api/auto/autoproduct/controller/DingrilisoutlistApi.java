...
* @description:用于浙大钉日历项目签退人员列表
* */
public class DingrilisoutlistApi{

    public static JSONObject dingrilisoutlist(String appid, String xgh, String id){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrilisoutlist/service",map,"utf-8");

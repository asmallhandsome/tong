...
* @description:用于共享个人日历
* */
public class DingrilishareApi{

    public static JSONObject dingrilishare(String appid, String xgh, String to, String type){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrilishare/service",map,"utf-8");

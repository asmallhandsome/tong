...
* @description:用于浙大钉日历项目参与人列表
* */
public class DingriliusrlistApi{

    public static JSONObject dingriliusrlist(String appid, String xgh, String id){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingriliusrlist/query",map,"utf-8");

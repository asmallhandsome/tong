...
* @description:用于取消订阅团队日历
* */
public class DingcalcancelApi{

    public static JSONObject dingcalcancel(String appid, String cid, String xgh){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingcalcancel/service",map,"utf-8");

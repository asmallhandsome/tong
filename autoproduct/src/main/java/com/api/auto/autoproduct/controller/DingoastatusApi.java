...
* @description:用于钉钉OA消息状态更新
* */
public class DingoastatusApi{

    public static JSONObject dingoastatus(String appid, Long id, String status, String color){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingoastatus/service",map,"utf-8");

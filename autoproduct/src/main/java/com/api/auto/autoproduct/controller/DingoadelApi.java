...
* @description:用于撤销钉钉OA消息
* */
public class DingoadelApi{

    public static JSONObject dingoadel(String appid, Long id){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingoadel/service",map,"utf-8");

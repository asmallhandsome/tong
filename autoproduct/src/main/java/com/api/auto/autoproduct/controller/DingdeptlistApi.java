...
* @description:用于钉钉部门列表获取接口
* */
public class DingdeptlistApi{

    public static JSONObject dingdeptlist(String appid, String parentid){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingdeptlist/query",map,"utf-8");

...
/**
* @createDate:Tue Sep 19 14:31:54 CST 2023
* @description:用于创建浙大钉部门
* */
public class DingdeptaddApi{

    public static JSONObject dingdeptadd(String appid, String parentid, String name, String order, String hide, String outerdept, String identifier){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingdeptadd/service",map,"utf-8");

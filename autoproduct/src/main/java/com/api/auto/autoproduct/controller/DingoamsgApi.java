...
* @description:用于发送钉钉OA消息
* */
public class DingoamsgApi{

    public static JSONObject dingoamsg(String appid, String userids, String title, String description, String link, String image, String status, String color, String attr){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingoamsg/service",map,"utf-8");

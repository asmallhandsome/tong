...
* @description:用于浙大钉个人日历状态（空闲）列表
* */
public class DingrilistatusApi{

    public static JSONObject dingrilistatus(String appid, String xgh, Date start, Date end){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrilistatus/query",map,"utf-8");

...
* @description:用于订阅浙大钉团队日历
* */
public class DingcaldyApi{

    public static JSONObject dingcaldy(String appid, String cid, String xgh){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingcaldy/service",map,"utf-8");

...
* @description:用于删除浙大钉团队日历
* */
public class DingcaldelApi{

    public static JSONObject dingcaldel(String appid, String cid, String xgh){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingcaldel/service",map,"utf-8");

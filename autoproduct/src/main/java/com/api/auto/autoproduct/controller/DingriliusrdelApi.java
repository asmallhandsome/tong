...
* @description:用于删除浙大钉日历项目参与人
* */
public class DingriliusrdelApi{

    public static JSONObject dingriliusrdel(String appid, String xgh, String id, String attendees){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingriliusrdel/service",map,"utf-8");

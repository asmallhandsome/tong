...
* @description:用于编辑更新浙大钉个人日历项目
* */
public class DingriliupdateApi{

    public static JSONObject dingriliupdate(String appid, String id, String xgh, String title, String description, String addr, Date start, Date end, String attendees, String remind){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingriliupdate/service",map,"utf-8");

...
* @description:用于取消共享个人日历
* */
public class DingrilisharedelApi{

    public static JSONObject dingrilisharedel(String appid, String xgh, String to){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingrilisharedel/service",map,"utf-8");

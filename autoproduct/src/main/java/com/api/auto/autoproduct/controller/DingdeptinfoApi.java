...
* @description:用于获取部门详细信息
* */
public class DingdeptinfoApi{

    public static JSONObject dingdeptinfo(String appid, String deptid){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingdeptinfo/query",map,"utf-8");

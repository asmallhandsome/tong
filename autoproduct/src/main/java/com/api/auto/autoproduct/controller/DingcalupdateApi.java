...
* @description:用于更新团队日历信息
* */
public class DingcalupdateApi{

    public static JSONObject dingcalupdate(String appid, String cid, String xgh, String title, String description){
        try {
            ...
            // http获取最后的返回结果
            String result = HttpRequestUtils.doPost("https://api.zju.edu.cn/api/dingcalupdate/service",map,"utf-8");
